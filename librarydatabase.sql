DROP DATABASE IF EXISTS books_library;
CREATE DATABASE books_library;

CREATE TABLE login ( ID integer not null PRIMARY KEY AUTO_INCREMENT,
                   username varchar(30) not null,
                   password varchar(15) not null
) ENGINE=INNODB;

CREATE TABLE address ( ID integer not null PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE library_user( ID integer not null PRIMARY KEY AUTO_INCREMENT,
                   ...
                   FOREIGN KEY (family_adult_id) REFERENCES library_user(ID)
) ENGINE=INNODB;
...
CREATE TABLE author ( ID integer not null PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE borrowing ( ID integer not null PRIMARY KEY AUTO_INCREMENT,
